...
DUH *dumb_load_mod(const char *filename, int _restrict);
...
DUH *dumb_read_mod(DUMBFILE *f, int _restrict);
...
DUH *dumb_load_mod_quick(const char *filename, int _restrict);
...
DUH *dumb_read_mod_quick(DUMBFILE *f, int _restrict);
...
DUH *dumb_read_okt_quick(DUMBFILE *f, int _restrict);
